  ...
  with tf.Session() as sess:
    ...
    for i in range(epoch):
      ...
      while right <= upper_bound:
        train_step.run(feed_dict={x: x_train[left:right], y: y_train[left:right], keep_prob1:0.75, keep_prob2: 0.5})
        left += batch_size
        right += batch_size
...
train(0, 25000, 50, 60, "./train0.ckpt")
train(25000, 50000, 50, 60, "./train1.ckpt")
